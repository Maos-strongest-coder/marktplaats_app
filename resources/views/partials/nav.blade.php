<nav class="bg-gray-800">
    ...
    <div class="ml-10 flex items-baseline space-x-4">
        ...
        <a href="{{ route('register') }}" class="{{ request()->routeIs('register') ? 'bg-black text-white' : 'text-white hover:bg-white/5 hover:text-blue-300' }} px-3 py-2 rounded-md text-sm font-medium">
            Create an Account
        </a>
        @endguest
    </div>
