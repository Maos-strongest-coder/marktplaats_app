...
@section('content')
    <div class="flex h-[80vh] bg-white border rounded-lg overflow-hidden max-w-6xl mx-auto my-6">
        ...
        <div class="w-1/3 border-r bg-gray-50 flex flex-col h-full">
            ...
            <div class="p-4 font-bold border-b bg-gray-100 flex justify-between items-center shrink-0">
                <h2 class="font-bold text-base text-gray-900 mb-2">Bids</h2>
            </div>

            <ul class="divide-y flex-1 overflow-y-auto">
    ...
    <div class="p-4 border-t bg-white shrink-0 sticky bottom-0">     
